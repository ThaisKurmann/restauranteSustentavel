...
import FinalizarPedidoButton from "../components/Pedidos/FinalizarPedidoButton";
import styles from "./PedidoPage.module.css";
import FinalizarPedidoPage from "./FinalizarPedidoPage";
...
const SinglePedidoPage: React.FC=  () => {
    ...
    return(
        <div>
          ...
          {/*Solucao temporaria: FUTURAMENTE ALTERAR MARGIN*/}
          <br></br>
          <br></br>
          <div >
          <FinalizarPedidoButton pedidoId={pedidoAtualId}/>
          </div>
